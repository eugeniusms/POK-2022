...
arrayCopy9Awal: .data 0, 0, 0, 0, 0, 0, 0, 0, 0
...
loopPengurangan:
     ...
     lb $a0, 0 ($t3) # mengambil data hasil pengurangan
     syscall # execute
...
output:
     subi $t0, $t0, 4 # mengurangi indeks pointer ke indeks sebelumnya
     li $v0, 1 # print integer
     la $a0, 0 ($t0) # mengambil isi dari array
     syscall # execute
     
     subi $t2, $t2, 1 # mengurangi counter
     bne $t2, 0, output # loop lagi sampai nol
     j exit
